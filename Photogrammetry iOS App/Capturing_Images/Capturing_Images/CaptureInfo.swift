...
/// This is a lightweight data object that holds a single capture sample, a reference to its capture directory and any metadata saved with the image.
struct CaptureInfo: Identifiable {
    ...
    /// This method deletes all associated metadata files synchronously. Don't call this method on the main thread.
    func deleteAllFiles() {
